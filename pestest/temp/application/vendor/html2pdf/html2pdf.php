...
if (!defined('__CLASS_HTML2PDF__'))
{
	...
	require_once(dirname(__FILE__).'/html2pdf/mypdf.class.php');	// classe mypdf dérivé de fpdf de Olivier PLATHEY 
	require_once(dirname(__FILE__).'/html2pdf/parsingHTML.class.php');	// classe de parsing HTML
	require_once(dirname(__FILE__).'/html2pdf/styleHTML.class.php');		// classe de gestion des styles
	...
	class HTML2PDF
	{
		...
		var $format			= 'letter';		// format de la page : A4, A3, ...
		 ...
		 * @return	null
		 */
		function HTML2PDF($sens = 'P', $format = 'letter', $langue='en', $marges = array(5, 5, 5, 8), $force_page = false)
		{
...
//			if ($this->style->value['height']) $h = $this->style->value['height'];
		...
		*/	
		...
		function textLOAD($langue)
		{
			...
			$file = dirname(__FILE__).'/html2pdf/langues/'.strtolower($langue).'.txt';
			if (!is_file($file))
			{
