...
<tr style="background:#9CF;font-size:14px; font-weight:bold">
    ...
    <td align="center" width="15%"><?php echo  'Right Answer' ?></td>
...
<tr class="row<?php if($id%2 == 0) echo 2 ?>" id="row_<?php echo isset($list['uid'])?$list['uid']:''?>">
    ...
    <img src="<?php echo url::base()?>uploads/answer/<?php echo $list['answerright'][0]['images']?>" />
    <?php }else{ ?>
...
<div class='pagination2' style="float: right;"><?php echo isset($this->pagination)?$this->pagination:''?> 
