...
<tr>
    ...
    <td align="right">
    	<button type="button" name="Submit2" class="button" tabindex="7" onclick="location.href='<?php echo $this->site['base_url']?>mypage/testing'"><span>Back to List</span></button>
    </td>
</tr>
</table>
...
<div class='pagination' style="clear: both;float: right;"><?php echo isset($this->pagination)?$this->pagination:''?><br />
</div>
<div style="clear: both;text-align: center;"><button type="button" name="Submit2" class="button" tabindex="7" onclick="location.href='<?php echo $this->site['base_url']?>mypage/testing'"><span>Back to List</span></button></div>
