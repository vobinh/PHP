...
<div class='pagination' style="float: right;"><?php echo isset($this->pagination)?$this->pagination:''?></div>
<br clear="all" />
</div>
<div id="tabs-2">
  ...
  <div id="tabs-3">
   ...
   <?php }?>
   <div id="chartcategory" style="min-width: 950px; height: 400px; margin: 0 auto"></div>
  </div>
</div>
</form>
