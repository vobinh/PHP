  ...
  <tr>
    <td align="center" style="padding:0px 0;">    
    	<div class="frm_login" style="width:100%">
            ...
            <div class="forgotpass_top" style="font-size: 18px;  font-weight:bold;padding: 10px;color:#7f4f26;text-align:left;">Registration Form</div>
            <table class="register" align="center" border="0" cellspacing="0" cellpadding="8" width="100%">
            <tr>
                <td width="37%" align="right" class="padbot10" style="padding-bottom:10px;vertical-align: bottom"><?php echo Kohana::lang('register_lang.lbl_email')?>&nbsp;&nbsp;</td>
                
              <td width="63%" align="left" class="pad10">
              <font color="#FF0000"><span id="noticemail" style="float:left"></span></font><br /> 
              <input autocomplete="off" name="txt_email" tabindex="3" type="text" onkeypress="return  keyPhone(event); " id="txt_email_dialog" value="<?php echo isset($mr['cus_email'])?$mr['cus_email']:(isset($indata['txt_email'])?$indata['txt_email']:'')?>" style="width:240px;height:30px;"  > 
            ...
            <tr>
              ...
              <td class="pad10" align="left"><p><span ><font size="3px">Do you have a sponsor? </font>&nbsp;&nbsp;</span>
                ...
                <b>No</b>
                  ...
                  will receive e-mail notifications of your progress.<br /><br /> </font></p>              </td>
            </tr>
            ...
            <tr>
              <td class="padbot10" style="padding-bottom:10px;" align="right">&nbsp;</td>
              <td class="pad10" align="left">
                <input type="checkbox" name="chk_sendmail" id="chk_sendmail" style="width:20px;vertical-align: middle;" />
              <span>Disable e-mail notifications from Pestest.com.</span></td>
            </tr>
            </table>
<footer >
           	<div style="padding-left: 42%;float: left;">
