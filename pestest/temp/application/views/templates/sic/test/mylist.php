...
<tr>
    ...
    <a href="<?php echo url::base()?>test/showlist">My Tests</a></td>
</tr>
</table>
<span style="padding-left: 5px;font-weight: bold;">Below are the tests that you have already purchased or unlocked </span>
