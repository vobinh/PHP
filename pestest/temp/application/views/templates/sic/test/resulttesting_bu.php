	 ...
	 foreach($mr['arrayquestion'] as $value){?>
        ...
        <td align="left" >
       	   <span style="color:#FF0000"> Question: <?php echo isset($value['question'])?$value['question']:'';?>
       	   		 ...
       	   		 <?php  if($value['hasanswer']!='')
				 			echo'<br />Your Answer: '.$value['hasanswer'];
						else    if($value['hasimages']!='')
...
<div id="contail" style="padding: 10px;border: solid 1px #ccc;margin-top: 15px; margin-left:48%; box-shadow:#bbb 0 0 5px;">
<?php
		$arraytest = array();
	    $arrayhas = array();
