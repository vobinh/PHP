...
<html><head><title>Transaction Results</title></head>
<body bgcolor="#FFFFFF">
<table width="450" border="0" height="81" bordercolor="#000000" cellspacing="0" align="center">
  ...
  <tr> 
    <td colspan="2" bgcolor="#FFFFFF" bordercolor="#FFFFFF"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="3" color="#990000">Error!</font></b></div>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td class="tabledata" width="59%" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
      <? if (isset($HTTP_GET_VARS['pg_authorization_code']))
