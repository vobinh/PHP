...
class Admin_login_Controller extends Template_Controller {
    ...
    public function _check_email_db($array, $field) {
        if (!Model::factory('administrator')->field_value_exist('administrator_email', $array[$field])) {
    ...
    public function request_newpass() {
        ...
        $result = ORM::factory('administrator')->where('administrator_email', $frm['txt_email'])->find();
