<form action="<?php echo url::base().uri::segment(1)?>/save_login" method="post">
...
<tr height="45">
    <td>&nbsp;</td>
    <td valign="top"><a href="<?php echo url::base().uri::segment(1)?>/forgot_pass"><?php echo Kohana::lang('account_lang.lbl_forgot_pass')?>?</a></td>
</tr>
</table>
