...
class Admin_account_Controller extends Template_Controller
{
    ...
    private function _get_frm_valid()
    {
		...
		if($_POST)
    	{
			...
			else
			{
                ...
                if($hd_id) url::redirect(url::base().'admin_account/edit/'.$hd_id);
                else url::redirect(url::base().'admin_account/create');
				die();
			}
        }
    }
    ...
    {   	    	
		...
		if(isset($_POST['hd_save_add']))
			url::redirect(url::base().'admin_account/create');		
		elseif(empty($frm['hd_id']))
			url::redirect(url::base().'admin_account');
		else
			url::redirect(url::base().'admin_account/edit/'.$frm['hd_id']);
		die(); 	
    }   
