...
class Contact_Controller extends Template_Controller
{
	...
	private function send_mailgun_contact($record){
        ...
        //HTML message
        $html_content = $this->data_template_model->get_value('EMAIL_CONTACT', $this->get_client_lang());
        //Replate content
    ...
    public function sm() {
        ...
        if ($record)
        	$this->send_mailgun_contact($record);
