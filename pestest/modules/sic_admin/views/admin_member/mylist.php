...
<tr class="list_header">
    ...
    <td align="center">No. of Lesson Modules</td>
 ...
 <tr class="tr<?php if($id%2 == 0) echo 0; else echo 1?>" id="row_<?php echo $list['id']?>">
    <td align="center"><?php echo $list['title'] ?></td>
  	<td align="center"><?php echo !empty($list['lesson_count'])?$list['lesson_count']:'0' ?></td>
   <!--  <td align="center"><?php //echo $list['time_value'] ?> <?php //echo($list['time_value'] >1)?' minutes':" minute"?></td> -->
    <td align="center">
	<?php if(isset($list['day_valid']) && ($list['day_valid']) >0) {?>
	<?php echo $list['day_valid']?> <?php echo($list['day_valid'] >1)?' days':" day"?>
    <?php }else{ ?>
    No limit day
    <?php } ?>
    </td>
  ...
  <?php echo !empty($list['description'])?'Description: '.$list['description']:"" ?></td></tr>
  <?php } // end if ?>
  <?php } else{
