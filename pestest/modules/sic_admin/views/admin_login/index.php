...
<tr>
    <td>
        ...
        <tr>
            <td class="login_logo">
                <a target="_blank" href="<?php echo url::base()?>"><img src="<?php echo linkS3; ?>site/<?php echo $this->site['site_logo']?>" <?php echo $this->get_thumbnail_size(linkS3.'site/'.$this->site['site_logo'],400,120)?>/></a>
            </td>
		</tr>
		</table>
	</td>
