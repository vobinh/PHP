...
function close_form_crop_company()
   {
    $( "#wrap_crop_company" ).dialog( "destroy" );
  }
</script>
<div  class="container">
...
$(function(){
     var options =
        ...
        document.querySelector('#btnCrop_company').addEventListener('click', function(){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo url::base() ?>admin_courses/save_img',
                data: {image: img},
                dataType: 'json',
                success: function (resp) { 
                   document.querySelector('#image_company_menu').innerHTML += '<input type="hidden" name="image_company" value="'+resp+'">';
                   $('.loading_img').hide();
                }
            });
