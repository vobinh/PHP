...
</style><link rel="stylesheet" href="<?php echo $this->site['base_url']?>/js/jquery/jquery-ui.css">
         ...
         <tr>
            ...
            <td width="5%">
            	<select name="sel_month" id="sel_month">
                		<?php for($i=1;$i<13;$i++) {?>
                         <option value="<?php echo $i ?>" <?php if(isset($mr['sel_month']) && $mr['sel_month']==$i)  {?> selected="selected" <?php }?>><?php echo $i ?></option>
                        <?php } ?>
                </select>
            </td>
