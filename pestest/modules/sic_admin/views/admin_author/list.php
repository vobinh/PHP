<form name="frmlist" id="frmlist" action="<?php echo url::base() ?>admin_author/search" method="post">
<table class="title" cellspacing="0" cellpadding="0">
  <tr>
    <td class="title_label"><?php echo 'Author'?></td>
    <td class="title_button">
    <?php if ($this->sess_admin['level'] == 1) { ?>
    <button type="button" class="button new" onclick="javascript:location.href='<?php echo url::base() ?>admin_author/create'"/>
...
<tr class="row<?php if($id%2 == 0) echo 2 ?>" id="row_<?php echo $list['uid']?>">
  	<td align="center"><?php echo $list['fname']?></td>
    <td align="center"><?php echo $list['lname'] ?></td>
    <td align="center"><?php echo $list['email'] ?></td>
    
    <td align="center">
  <a href="<?php echo url::base() ?>admin_author/setstatus/<?php echo $list['uid'] ?>">      
    ...
    <a href="<?php echo url::base() ?>admin_author/edit/<?php echo $list['uid'] ?>" class="ico_edit"><?php echo Kohana::lang('global_lang.btn_edit') ?></a>
...
<form id="frm_display" name="frm_display" method="post" action="<?php echo $this->site['base_url']?>admin_author/display">
