...
<input type="hidden" value="<?php echo isset($mr['chartcategory'][0]['test'])?$mr['chartcategory'][0]['test']:''?>" name="hd_test"/>
<input type="hidden" value="<?php echo isset($mr['chartcategory'][0]['testing_code'])?$mr['chartcategory'][0]['testing_code']:''?>" name="testing_code"/>
...
<div style="float:right;margin-top: 7px;">
 ...
 <?php if(empty($payment)) {?>
 	<div id='lastest' style="margin-top: 10px;">
    	<span style="font-size: 15px;color: #8A8A8A;"> - You have not purchased any test, please purchase new test </span>
    </div> 
...
<div id='lastest' style="margin-top: 10px;">
	<div id='content_lasttest' style="width:30%;border: solid 1px #ccc;padding: 0px;float: left;box-shadow:#bbb 0 0 5px;height: 420px;">   <br />
   
  </div>
    <div id='chart_lasttest' style="width: 43%;border: solid 1px #ccc;padding: 10px; margin-left:32%;box-shadow:#bbb 0 0 5px; ">
     <?php
		$arraytest = array();
	    $arrayhas = array();
...
<?php }?>
<div align="center" style="padding-top: 15px; clear:both; padding-bottom: 15px; padding-left:80px;">
<?php if(isset($mr['chartcategory'][0]['test'])){?>
<form id="testagain" method="post" action="<?php echo url::base() ?>test/testing">
<input type="hidden" value="<?php echo $mr['chartcategory'][0]['test']?>" name="sel_test"/>
