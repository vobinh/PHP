    ...
    <td align="center" style="padding:0px 0;">    
    	<div class="frm_login" style="width:100%">
            ...
            <tr>
                ...
                <td class="pad10" align="left"><input name="txt_email" tabindex="3" type="text" onkeypress="return  keyPhone(event)" id="txt_email_dialog" value="<?php echo isset($mr['cus_email'])?$mr['cus_email']:(isset($indata['txt_email'])?$indata['txt_email']:'')?>" style="width:240px;height:30px;"> 
