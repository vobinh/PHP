        ...
        $('#container').highcharts({
			...
			}?>
			{
					...
					data:[
						...
						<?php 
						echo '[ 0,'.$mr['last_test'][0]['test']['pass_score'].'],';
						echo '[ '.(count($chartlist)- 1) .','.$mr['last_test'][0]['test']['pass_score'].'],';?>
...
'style="padding-top: 15px; clear:both; padding-bottom: 15px; padding-left:80px;"':
'style="padding-top: 15px; clear:both; padding-bottom: 15px; margin-left: -200px;"'?>>
