...
class Controller extends Controller_Core
{
	...
	{		
		...
		$this->sess_cus = $this->Login_Model->get('customer');		
	} 
	...
	{	
		...
		$this->sess_admin = $this->Login_Model->get('admin', FALSE);
		...
		//if($this->uri->segment(1) != "admin_login") $this->Login_Model->save_active_last($this->sess_admin['id']);			
	}  
